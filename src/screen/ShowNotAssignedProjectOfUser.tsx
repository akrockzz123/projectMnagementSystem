...
/*error_delete_from_user: {},
    ...
    */
    ...
    const AssignHandler = (userid : any,project_id : string,navigate : any,dispatch : any, e : React.MouseEvent<HTMLButtonElement>) => {
...
const ProjectsOfUser: React.FunctionComponent<IAppProps> = (props) => {
  ...
  const { course_not_assign ,course_not_assign_loading ,course_not_assign_success,course_not_assign_error}  = notassigned
...
<tbody>
    ...
    {course_not_assign.map(u  => 
      <tr >
        ...
        <td ><Button variant='primary' onClick = { (event) => AssignHandler(ids,u.project_id,navigate,dispatch,event)}>Assign</Button> </td>
      </tr>
    )}
